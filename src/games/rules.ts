...
export const GAME_RULES: Record<GameType, string> = {
  ...
  nassau: 'Three separate bets in one: front 9, back 9, and the full 18. Going down mid-nine? Call a "press" to start a fresh side bet from that hole to the end of the nine. Turn on auto-press and that happens by itself the moment a side goes 2 down — and a press that goes 2 down presses again, which is how a quiet round turns into several bets at once.',
};
